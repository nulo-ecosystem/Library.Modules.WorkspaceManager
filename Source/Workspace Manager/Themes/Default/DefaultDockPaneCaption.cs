...
namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    internal class DefaultDockPaneCaption : DockPaneCaptionBase {
        ...
        private void DrawCaption(Graphics g) {
            ...
            if(ShouldShowAutoHideButton) { rectCaptionText.Width -= ButtonAutoHide.Width + ButtonGapBetween; }
        ...
        private void SetButtonsPosition() {
            ...
            if(CloseButtonVisible) { point.Offset(-(buttonWidth + ButtonGapBetween), 0); }

            ButtonAutoHide.Bounds = DrawHelper.RtlTransform(this, new Rectangle(point, buttonSize));
            if(ShouldShowAutoHideButton) { point.Offset(-(buttonWidth + ButtonGapBetween), 0); }
