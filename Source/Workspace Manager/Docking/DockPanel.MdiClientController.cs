...
namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    partial class DockPanel {
        ...
        private class MdiClientController : NativeWindow, IComponent, IDisposable {
            ...
            public bool AutoScroll {
                ...
                set {
                    ...
                    m_autoScroll = value;
                    if(MdiClient != null) { UpdateStyles(); }
                }
            }
            ...
            public BorderStyle BorderStyle {
                set {
                    ...
                    if(!Enum.IsDefined(typeof(BorderStyle), value)) { throw new InvalidEnumArgumentException(); }
                    m_borderStyle = value;
            ...
            private void UpdateStyles() {
                ...
                if(!Win32Helper.IsRunningOnMono) {
                    _ = NativeMethods.SetWindowPos(MdiClient.Handle, IntPtr.Zero, 0, 0, 0, 0, Win32.FlagsSetWindowPos.SWP_NOACTIVATE | Win32.FlagsSetWindowPos.SWP_NOMOVE | Win32.FlagsSetWindowPos.SWP_NOSIZE | Win32.FlagsSetWindowPos.SWP_NOZORDER | Win32.FlagsSetWindowPos.SWP_NOOWNERZORDER | Win32.FlagsSetWindowPos.SWP_FRAMECHANGED);
                }
            }
        }
        ...
        private void ParentFormMdiChildActivate(object sender, EventArgs e) {
            if(GetMdiClientController().ParentForm == null) { return; }
            if(GetMdiClientController().ParentForm.ActiveMdiChild is not IDockContent content) { return; }
