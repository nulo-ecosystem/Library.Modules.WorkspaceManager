...
namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    public class VisualStudioToolStripRenderer : ToolStripProfessionalRenderer {
        ...
        private readonly SolidBrush _statusBarBrush;
        ...
        protected override void OnRenderMenuItemBackground(ToolStripItemRenderEventArgs e) {
            ...
            if(e.Item.Enabled) {
                ...
                if(isMenuDropDown && e.Item.Pressed) {
                    ...
                    // Fix item rect.
                    Rectangle itemRect = isMenuDropDown ? new Rectangle(contentRect.X + 2, contentRect.Y - 2, contentRect.Width - 5, contentRect.Height + 3) : new Rectangle(contentRect.X, contentRect.Y - 1, contentRect.Width, contentRect.Height + 1);
        ...
        protected override void OnRenderGrip(ToolStripGripRenderEventArgs e) {
            ...
            if(numRectangles > 0) {
                ...
                for(int i = 0; i < numRectangles; i++) {
                    shadowRects[i] = (toolStrip.Orientation == Orientation.Horizontal) ? new Rectangle(startX, startY, 1, 1) : new Rectangle(startY, startX, 1, 1);
                    startY += 4;
                }
        ...
        protected override void OnRenderOverflowButtonBackground(ToolStripItemRenderEventArgs e) {
            ...
            if(e.Item.Pressed) { _palette.CommandBarMenuPopupDefault.BackgroundTop = _palette.CommandBarToolbarOverflowPressed.Background; }
            base.OnRenderOverflowButtonBackground(e);
            if(e.Item.Pressed) { _palette.CommandBarMenuPopupDefault.BackgroundTop = cache; }
        }
