namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    public abstract class InertButtonBase : Control {
        ...
        protected override void OnMouseMove(MouseEventArgs e) {
            ...
            if(IsMouseOver != over) { IsMouseOver = over; }
        }
        ...
        protected override void OnPaint(PaintEventArgs e) {
            if(HoverImage != null) {
                if(IsMouseOver && Enabled) {
                    e.Graphics.DrawImage(IsMouseDown ? PressImage : HoverImage, PatchController.EnableHighDpi == true ? ClientRectangle : new Rectangle(0, 0, Image.Width, Image.Height));
                } else {
                    e.Graphics.DrawImage(Image, PatchController.EnableHighDpi == true ? ClientRectangle : new Rectangle(0, 0, Image.Width, Image.Height));
                }
                base.OnPaint(e);
                return;
            }
        ...
        public void RefreshChanges() {
            ...
            if(mouseOver != IsMouseOver) { IsMouseOver = mouseOver; }
            OnRefreshChanges();
        }
