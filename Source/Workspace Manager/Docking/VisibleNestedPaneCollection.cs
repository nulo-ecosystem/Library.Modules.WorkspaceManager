    ...
    public sealed class VisibleNestedPaneCollection : ReadOnlyCollection<DockPane> {
        ...
        private void CalculateBounds() {
            ...
            for(int i = 1; i < Count; i++) {
                ...
                _ = (status.DisplayingAlignment == DockAlignment.Left || status.DisplayingAlignment == DockAlignment.Right);
                ...
                if(status.DisplayingAlignment == DockAlignment.Left) {
                    rectThis.Width = (int)(rect.Width * status.DisplayingProportion) - (pane.DockPanel.Theme.Measures.SplitterSize / 2);
                    ...
                    rectPrev.Width = rect.Width - (int)(rect.Width * status.DisplayingProportion) - (pane.DockPanel.Theme.Measures.SplitterSize / 2);
                    ...
                    rectThis.Height = (int)(rect.Height * status.DisplayingProportion) - (pane.DockPanel.Theme.Measures.SplitterSize / 2);
                    ...
                    rectPrev.Height = rect.Height - (int)(rect.Height * status.DisplayingProportion) - (pane.DockPanel.Theme.Measures.SplitterSize / 2);
