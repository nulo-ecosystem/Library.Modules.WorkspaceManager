namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    public class DockContentHandler : IDisposable, IDockDragSource {
        ...
        public DockContentHandler(Form form, GetPersistStringCallback getPersistStringCallback) {
            if(form is not IDockContent) { throw new ArgumentException(Strings.DockContent_Constructor_InvalidForm, nameof(form)); }
        ...
        public double AutoHidePortion {
            ...
            set {
                ...
                if(SuspendAutoHidePortionUpdates) { return; }
                if(Math.Abs(m_autoHidePortion - value) < double.Epsilon) { return; }
                m_autoHidePortion = value;
                if(DockPanel == null) { return; }
                if(DockPanel.ActiveAutoHideContent == Content) { DockPanel.PerformLayout(); }
            }
        }
        ...
        public bool CloseButton {
            ...
            set {
                if(m_closeButton == value) { return; }
                m_closeButton = value;
                if(IsActiveContentHandler) { Pane.RefreshChanges(); }
            }
        }
        ...
        public bool CloseButtonVisible {
            ...
            set {
                if(m_closeButtonVisible == value) { return; }
        ...
        private DockState DefaultDockState {
            get {
                if(ShowHint != DockState.Unknown && ShowHint != DockState.Hidden) { return ShowHint; }
                if((DockAreas & DockAreas.Document) != 0) { return DockState.Document; }
                if((DockAreas & DockAreas.DockRight) != 0) { return DockState.DockRight; }
                if((DockAreas & DockAreas.DockLeft) != 0) { return DockState.DockLeft; }
                if((DockAreas & DockAreas.DockBottom) != 0) { return DockState.DockBottom; }
                if((DockAreas & DockAreas.DockTop) != 0) { return DockState.DockTop; }
        ...
        private DockState DefaultShowState {
            get {
                if(ShowHint != DockState.Unknown) { return ShowHint; }
                if((DockAreas & DockAreas.Document) != 0) { return DockState.Document; }
                if((DockAreas & DockAreas.DockRight) != 0) { return DockState.DockRight; }
                if((DockAreas & DockAreas.DockLeft) != 0) { return DockState.DockLeft; }
                if((DockAreas & DockAreas.DockBottom) != 0) { return DockState.DockBottom; }
                if((DockAreas & DockAreas.DockTop) != 0) { return DockState.DockTop; }
                if((DockAreas & DockAreas.Float) != 0) { return DockState.Float; }
                return DockState.Unknown;
            }
        }
        ...
        public DockAreas DockAreas {
            ...
            set {
                if(m_allowedAreas == value) { return; }
                if(!DockHelper.IsDockStateValid(DockState, value)) { throw (new InvalidOperationException(Strings.DockContentHandler_DockAreas_InvalidValue)); }
                m_allowedAreas = value;
                if(!DockHelper.IsDockStateValid(ShowHint, m_allowedAreas)) { ShowHint = DockState.Unknown; }
            }
        }
        ...
        public DockState VisibleState {
            ...
            set {
                if(m_visibleState == value) { return; }
        ...
        public bool IsFloat {
            ...
            set {
                ...
                if(visibleState == DockState.Unknown) { throw new InvalidOperationException(Strings.DockContentHandler_IsFloat_InvalidValue); }
        ...
        private void RemoveFromPane(DockPane pane) {
            ...
            SetPane(null);
            if(pane.Contents.Count == 0) { pane.Dispose(); }
        }
        ...
        internal void SetDockState(bool isHidden, DockState visibleState, DockPane oldPane) {
            if(IsSuspendSetDockState) { return; }
        ...
        public bool IsDockStateValid(DockState dockState) {
            return (DockPanel == null || dockState != DockState.Document || DockPanel.DocumentStyle != DocumentStyle.SystemMdi) && DockHelper.IsDockStateValid(dockState, DockAreas);
        }
        ...
        internal void SetVisible() {
            ...
            if(Form.Visible != visible) { Form.Visible = visible; }
        }

        private void SetParent(Control value) {
            if(Form.Parent == value) { return; }
            ...
            // MDI child form get activated.
            // !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
            if(bRestoreFocus && !Win32Helper.IsRunningOnMono) { Activate(); }
        ...
        public void Show(DockPanel dockPanel, DockState dockState) {
            ...
            if(dockState == DockState.Float) {
                ...
                Pane = paneExisting == null ? DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, dockState, true) : paneExisting;
            }
        ...
        public void Show(DockPane pane, IDockContent beforeContent) {
            if(pane == null) { throw (new ArgumentNullException(Strings.DockContentHandler_Show_NullPane)); }
            if(beforeContent != null && pane.Contents.IndexOf(beforeContent) == -1) { throw (new ArgumentException(Strings.DockContentHandler_Show_InvalidBeforeContent)); }
        ...
        public void Show(DockPane previousPane, DockAlignment alignment, double proportion) {
            if(previousPane == null) { throw (new ArgumentException(Strings.DockContentHandler_Show_InvalidPrevPane)); }
            if(DockHelper.IsDockStateAutoHide(previousPane.DockState)) { throw (new ArgumentException(Strings.DockContentHandler_Show_InvalidPrevPane)); }
        ...
        public ContextMenuStrip TabPageContextMenuStrip {
            ...
            set {
                if(value == m_tabPageContextMenuStrip) { return; }
        ...
        bool IDockDragSource.CanDockTo(DockPane pane) {
            ...
            if(Pane == pane && pane.DisplayingContents.Count == 1) { return false; }
            return true;
        }
        ...
        Rectangle IDockDragSource.BeginDrag(Point ptMouse) {
            ...
            if(ptMouse.X > location.X + size.Width) { location.X += ptMouse.X - (location.X + size.Width) + DockPanel.Theme.Measures.SplitterSize; }
        ...
        public void FloatAt(Rectangle floatWindowBounds) {
            ...
            _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, floatWindowBounds, true);
        }
        ...
        public void DockTo(DockPane pane, DockStyle dockStyle, int contentIndex) {
            if(dockStyle == DockStyle.Fill) {
                ...
                while(visiblePanes <= contentIndex && convertedIndex < Pane.Contents.Count) {
                    if(Pane.Contents[convertedIndex] is DockContent window && !window.IsHidden) { ++visiblePanes; }
                    ++convertedIndex;
                }
                ...
                if(contentIndex == -1 || !samePane) {
                    ...
                    if(oldIndex < newIndex) {
                        newIndex += 1;
                        if(newIndex > contents.Count - 1) { newIndex = -1; }
                    }
            ...
            if(PatchController.EnableActivateOnDockFix == true) { Pane.ActiveContent = Content; }
        }
        ...
        public void DockTo(DockPanel panel, DockStyle dockStyle) {
            ...
            if(dockStyle == DockStyle.Top) {
                _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, DockState.DockTop, true);
            } else if(dockStyle == DockStyle.Bottom) {
                _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, DockState.DockBottom, true);
            } else if(dockStyle == DockStyle.Left) {
                _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, DockState.DockLeft, true);
            } else if(dockStyle == DockStyle.Right) {
                _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, DockState.DockRight, true);
            } else if(dockStyle == DockStyle.Fill) {
                _ = DockPanel.Theme.Extender.DockPaneFactory.CreateDockPane(Content, DockState.Document, true);
            } else {
                return;
            }
        }
