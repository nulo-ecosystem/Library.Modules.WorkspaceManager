...
namespace Nulo.Modules.WorkspaceManager.Docking {
    ...
    public static class DrawHelper {
        ...
        public static Point RtlTransform(Control control, Point point) {
            return control.RightToLeft != RightToLeft.Yes ? point : new Point(control.Right - point.X, point.Y);
        }

        public static Rectangle RtlTransform(Control control, Rectangle rectangle) {
            return control.RightToLeft != RightToLeft.Yes ? rectangle : new Rectangle(control.ClientRectangle.Right - rectangle.Right, rectangle.Y, rectangle.Width, rectangle.Height);
        }
